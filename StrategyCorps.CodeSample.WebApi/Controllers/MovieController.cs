...
namespace StrategyCorps.CodeSample.WebApi.Controllers
{
    ...
    public class MovieController : ApiController
    {
        ...
        /// <summary>
        ///     Get a movie's alternative titles
        /// </summary>
        /// <remarks>
        ///     Get a movie's alternative titles
        /// </remarks>
        /// <param name="id">Movie id</param>
        [SwaggerResponse(HttpStatusCode.OK, "", typeof(AlternativeMovieTitleSearchResponseViewModel))]
        ...
        public IHttpActionResult AlternativeMovieTitles(int id)
        {
            ...
            try
            {
                var alternativeMovieTitleSearchResponseDto = _movieService.GetAlternativeMovieTitlesById(id);

                if (alternativeMovieTitleSearchResponseDto == null) return Content(HttpStatusCode.NotFound, $"The movie id {id} was not found.");

                var alternativeMovieTitleSearchResultViewModel = _mapper.Map<AlternativeMovieTitleSearchResponseDto, AlternativeMovieTitleSearchResponseViewModel>(alternativeMovieTitleSearchResponseDto);

                return Ok(alternativeMovieTitleSearchResultViewModel);
